 ...
 */
final class Version20230406092223 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE dangers ADD lat_danger VARCHAR(255) NOT NULL, ADD lng_danger VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE dangers DROP lat_danger, DROP lng_danger');
    }
}
